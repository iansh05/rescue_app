    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: SingleChildScrollView(
          physics: const BouncingScrollPhysics(), // Adds that premium bounce feel
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: Row(
                  children: [
                    const CircleAvatar(
                      radius: 24, 
                      backgroundColor: Color(0xFFE52E3D), 
                      child: Text("P", style: TextStyle(fontSize: 20, color: Colors.white, fontWeight: FontWeight.bold))
                    ),
              ...
              _buildSettingRow(Icons.security, "Safe Mode", "Auto-alert if check-in missed", 
                  trailing: Switch(value: true, onChanged: (v) {}, activeColor: const Color(0xFFE52E3D))),
