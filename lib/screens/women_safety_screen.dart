    ...
    body: Center(
      child: ConstrainedBox(
        ...
        child: Padding(
          ...
          // REPLACE THE COLUMN WITH A LISTVIEW
          child: ListView( 
            children: [
              // Inside your ListView children:
const SizedBox(height: 40),

// NEW ALIGNMENT: Everything in this Column will be aligned to the left
Column(
  ...
  children: [
    IconButton(
      ...
      constraints: const BoxConstraints(), // This removes extra internal padding
    ),
    const SizedBox(height: 12), // Space between arrow and Title
...
// ... rest of your code
              ...
              // CONTACTS LIST (Using shrinkWrap: true and physics: NeverScrollableScrollPhysics)
              // Since the parent is now a ListView, we don't need Expanded here.
